...
//    private lateinit var weatherForecastService: WeatherForecastInterface
    @Autowired
    private lateinit var  orchestrator : OrchestrationService
    ...
    fun getForecast(@PathVariable location: String): String {
        ...
        val locationId = orchestrator.getLocationId(location) ?: return "Nu s-au putut gasi date meteo pentru cuvintele cheie \"$location\"!"
        if(locationId.country in blackList)
            return "Nu se poate accesa locatia respectiva"

        return orchestrator.toHtml(orchestrator.getForecastData(orchestrator.getLocationId(location)!!))
...
//        locationId ?: return "Nu s-au putut gasi date meteo pentru cuvintele cheie \"$location\"!"
//
//        //verificare daca zona se afla in blacklist
//        if(locationId.country in blackList)
//            return "Nu se poate accesa locatia respectiva"
//
